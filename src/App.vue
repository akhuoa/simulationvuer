  ...
  data: function () {
    return {
      ...
      datasets: [
        ...
        { id: "workspace/b7c/rawfile/72a65d0890432b249be8cb0af48f249eb0dfae58/135.omex", label: "ISAN-135", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/72a65d0890432b249be8cb0af48f249eb0dfae58/157.omex", label: "ISAN-157", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/72a65d0890432b249be8cb0af48f249eb0dfae58/lorenz.omex", label: "ISAN-Lorenz", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/72a65d0890432b249be8cb0af48f249eb0dfae58/tt04.omex", label: "ISAN-TT04", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/72a65d0890432b249be8cb0af48f249eb0dfae58/geewhiz.omex", label: "ISAN-GeeWhiz", description: "COMBINE archive from PMR" },
      ],
      id: 0,
      ready: [],
    };
