...
export default {
  ...
  data: function () {
    return {
      ...
      pmrDatasets: [
        { id: "workspace/b7c/rawfile/4583102f73366b61022436119315ddbd0acbc967/135.omex", label: "135", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4583102f73366b61022436119315ddbd0acbc967/157.omex", label: "157", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4583102f73366b61022436119315ddbd0acbc967/lorenz.omex", label: "Lorenz", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4583102f73366b61022436119315ddbd0acbc967/tt04.omex", label: "TT04", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4583102f73366b61022436119315ddbd0acbc967/Gee_whiz_Exported.omex", label: "GeeWhiz", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4583102f73366b61022436119315ddbd0acbc967/cvs.omex", label: "CVS", description: "COMBINE archive from PMR" },
      ],
      id: 0,
      ready: [],
    };
