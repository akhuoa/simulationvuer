...
export default {
  ...
  data: function () {
    return {
      ...
      pmrDatasets: [
        { id: "workspace/b7c/rawfile/4b1f6ebce8c4811f25588759d8947a381622c6bf/135.omex", label: "135", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4b1f6ebce8c4811f25588759d8947a381622c6bf/157.omex", label: "157", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4b1f6ebce8c4811f25588759d8947a381622c6bf/lorenz.omex", label: "Lorenz", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4b1f6ebce8c4811f25588759d8947a381622c6bf/tt04.omex", label: "TT04", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4b1f6ebce8c4811f25588759d8947a381622c6bf/Gee_whiz_Exported.cellml.omex", label: "GeeWhiz", description: "COMBINE archive from PMR" },
        { id: "workspace/b7c/rawfile/4b1f6ebce8c4811f25588759d8947a381622c6bf/cvs.omex", label: "CVS", description: "COMBINE archive from PMR" },
      ],
      id: 0,
      ready: [],
    };
